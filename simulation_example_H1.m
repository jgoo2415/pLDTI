...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Simulation Example Code for time-dependent curves (H1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
q0=2;
y_array{q0,1}=init_template2b(nx,ny,nz,B); % generate the response vector (under the alternative hypothesis 1)
DD_array{q0,1}=dtilda(y_array{q0,1},B);  % ols of the diffusion tensor D 
